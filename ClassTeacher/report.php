                  ...
                  <form  method="post">
                    <div class="form-group row mb-3">
                        ...
                        <label class="form-control-label">Type<span class="text-danger ml-2">*</span></label>
                          <select  name="select" class="form-control mb-3" required>
                    ...
                    <button type="submit" name="btn" class="btn btn-primary">Select</button>
                  </form>
                </div>
              </div>
              </div>
    ...
    <?php
            ...
            { 
               ...
               ?>
                    ...
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Subject Attendance Report</h6>
                            <?php echo $statusMsg; ?>
                        </div>
                        <div class="card-body">
                        <form action="r.php" method="post">
                            ...
                            <button type="submit" name="view" class="btn btn-primary">Generate Report</button>
                        </form>
                        </div>
                    </div>
                    </div>
