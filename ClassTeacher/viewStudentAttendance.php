  ...
  if (isset($_GET['Id']) && isset($_GET['action']))
	{
      ...
      echo $Id2;
        $query = mysqli_query($conn,"DELETE FROM attendance WHERE st_id='$Id' and stat_date='$date' and sub_id='$_SESSION[sub_id]'") ;
        ...
        //   echo $statusMsg = "<div class='alert alert-success'  style='margin-right:700px;'>Created Successfully!</div>";
          ...
          echo "<script type = \"text/javascript\">
                window.location = (\"viewStudentAttendance.php\")
                </script>"; 
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <input type="text" class="form-control" required name="roll" value="<?php echo $row['st_name'];?>" id="exampleInputFirstName">
                        </div>
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                       ...
                       if($type == "1"){ //All Attendance
                        ...
                        $query = "SELECT * from students inner JOIN attendance on attendance.st_id=students.st_id where  students.st_id='$admissionNumber' and sub_id='$course' ORDER BY stat_date DESC";
                        // $query = "SELECT * from students inner JOIN attendance on attendance.st_id='$admissionNumber' where  sub_id=$course ";
                       ...
                       if($type == "2"){ //Single Date Attendance
                        ...
                        $query = "SELECT * from students inner JOIN attendance on attendance.st_id=students.st_id where students.st_id='$admissionNumber' and attendance.stat_date='$singleDate'  and sub_id='$course' order by stat_date asc";
                       ...
                       if($type == "3"){ //Date Range Attendance
                        ...
                        students.st_id='$admissionNumber' and attendance.stat_date between '$fromDate' and '$toDate'  and sub_id='$course' order by stat_date DESC";
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                <td><a href='?action=".$rows['course']."&Id=".$rows['st_id']."&Id2=".$rows['stat_date']."'><i class='fas fa-fw fa-trash'></i></a>
              ...
              <?php
                  if(isset($_POST['view']))
                  {
                    ...
                    if($type=='3'){
                      ...
                      $sql="SELECT * FROM attendance where st_id='$admissionNumber' and st_status=1  and attendance.st_date  between '$fromDate' and '$toDate'";
                      $sql1="SELECT * FROM attendance where st_id='$admissionNumber' and st_status=0 and sub_id='$_SESSION[sub_id]' and attendance.st_date and sub_id='$_SESSION[sub_id]'and between '$fromDate' and '$toDate'";
