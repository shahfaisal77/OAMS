...
if(isset($_POST['save'])){
    ...
    $_SESSION['date'];
        ...
        // $qurty=mysqli_query($conn,"select * from attendance  where sub_id ='$c' and stat_date='$_SESSION[date]' and st_id='$_POST[check]' ");
    ...
    $status = "";
        for($i = 0; $i < $N; $i++)
        {
                ...
                $admissionNo[$i]; //admission Number
                  ...
                  $qurty=mysqli_query($conn,"select * from attendance  where sub_id ='$c' and stat_date='$_SESSION[date]' and st_id= '$check[$i]' and tc_id='$_SESSION[userId]'");
                  ...
                  if($count == 0){ 
                      ...
                      // }
                          ...
                          $qquery=mysqli_query($conn,"insert into attendance(st_id,sub_id,tc_id,st_status,stat_date) 
                          values('$check[$i]','$c','$_SESSION[userId]','0','$_SESSION[date]')");
            ...
            <div class="row">
              ...
              <div class="card mb-4">
                ...
                <?php
                          ...
                          $query = "SELECT * FROM `students` where st_id in(SELECT st_id from st_sub where st_sub.sub_id in(SELECT sub_id from subject WHERE sub_id='$course') ORDER BY st_id ASC)";
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                <td><input name='check[]' type='checkbox' value=".$rows['st_id']." class='name' ></td>
