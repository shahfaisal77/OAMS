  ...
  if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "delete")
	{
        ...
        $query = mysqli_query($conn,"DELETE FROM st_sub WHERE st_id='$Id' and sub_id=' $sub_id'");
        ...
        if ($query == TRUE) {
          ...
          echo "<script type = \"text/javascript\">
                window.location = (\"student_subject.php\")
                </script>"; 
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                <td><a href='?action=delete&Id=".$rows['st_id']."&sub_id=".$course."'><i class='fas fa-fw fa-trash'></i></a></td>
