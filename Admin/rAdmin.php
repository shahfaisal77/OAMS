...
if(isset($_POST['save'])){
  ...
  $password=md5($password);
    ...
    $query=mysqli_query($conn,"select * from admininfo where username ='$username'");
    ...
    if($ret > 0){ 
        ...
        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>This User Address Already Exists!</div>";
        
    }
    else{

    $query=mysqli_query($conn,"INSERT into admininfo(fname,lname,email,phone,username,password)
     VALUES('$firstName','$lName','$emailAddress','$phoneNo','$username','$password')")or die("Not inserted");
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        $query=mysqli_query($conn,"select * from admininfo where id ='$Id'");
        ...
        if(isset($_POST['update'])){
          ...
          $password=md5($password);
            ...
            $query=mysqli_query($conn,"update admininfo set fname='$firstName',lname='$lName',email='$emailAddress', password='$password',phone='$phoneNo', username='$username' where id='$Id'")or die("not");
            if ($query =true) {
              echo "<script>
              alert('Data Updated Successfully');
            </script>";
                echo "<script type = \"text/javascript\">
                window.location = (\"rAdmin.php\")
                </script>"; 
            }
            else
            {
  ...
  if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "delete")
	{
        ...
        $query = mysqli_query($conn,"DELETE FROM admininfo WHERE id='$Id'");
      ...
      <div id="content">
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <!-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Administrator Registration</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Administrator Registration Form</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Administrator Registration Form</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                  ...
                  <div class="col-xl-6">
                        ...
                        <input type="text" class="form-control" required name="firstName" value="<?php echo $row['fname'];?>" id="exampleInputFirstName" pattern="[A-Za-z\s]{1,20}" title="Character Only i.e Suhail">
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Last Name<span class="text-danger ml-2">*</span></label>
                        <input type="text" class="form-control" required name="lastName" value="<?php echo $row['lname'];?>" id="exampleInputFirstName" pattern="[A-Za-z\s]{1,20}" title="Character Only i.e Suhail">
                        </div>
                        ...
                        <input type="text" class="form-control" required name="phone" value="<?php echo $row['phone'];?>" id="exampleInputFirstName" pattern="[+0-9-\s]{10,15}" title="Numeric Only Not Less than 10 i.e '+91-**********','0091 ***********'">
                        </div>
                        <div class="col-xl-6">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Admin Registration Form</h6>
                </div>
                <div class="table-responsive p-3">
                  ...
                  <?php
                      ...
                      $query = $query = "SELECT * from admininfo ORDER BY id asc";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
