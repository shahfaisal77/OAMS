 <ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center bg-gradient-primary  justify-content-center" href="index.php">
        <div class="sidebar-brand-icon" >
          <img src="img/logo/homePageIcon2.png">
        </div>
        <div class="sidebar-brand-text mx-3" style="font-size: 13px;">Online Attendance System</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="createClass.php">View Students</a>
            <a class="collapse-item" href="createClass.php">Update Students</a>
            <a class="collapse-item" href="createClass.php">View Students</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrapusers" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!-- <a class="collapse-item" href="rStudent.php">Register Student</a> -->
            <!-- <a class="collapse-item" href="rTeacher.php">Register Teacher</a> -->
            <a class="collapse-item" href="rAdmin.php">Register Administrator</a>
          </div>
        </div>
      </li>
      <hr class="sidebar-divider">
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrapassests" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Type of User</h6>
            <a class="collapse-item" href="createClassTeacher.php">Register Student</a>
            <a class="collapse-item" href="createClassTeacher.php">Register Teacher</a>
            <a class="collapse-item" href="assetsCategoryList.php">Register Administrator</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrapassests" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!-- <a class="collapse-item" href="rTeacher.php">Add Teacher</a> -->
            <a class="collapse-item" href="createClassTeacher.php">View Teachers</a>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!-- <a class="collapse-item" href="rStudent.php">Add Students</a> -->
           
            <a class="collapse-item" href="student.php">View Students</a>
            <!-- <a class="collapse-item" href="createClass.php">Update Students</a>
            <a class="collapse-item" href="createClass.php">View Students</a> -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="createClass.php">Subjects</a>
            <a class="collapse-item" href="student_subject.php">Student's Subjects</a>
            <!-- <a class="collapse-item" href="#">Member List</a> -->
          </div>
        </div>
      </li>
